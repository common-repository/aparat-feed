...
?>
<article id="post-<?php echo absint( $videoobject->id ); ?>" class="col-xs-6 col-sm-6 col-md-4" style="margin: 0 ;padding: 5px;">
	...
	<header class="panel box bottom-shadow" style="padding: 5px;">
		<figure class="category-post-image">
			<a href="<?php echo esc_url( $videoobject->frame ); ?>" title="<?php echo esc_attr( $videoobject->title ); ?>">
				<img style="margin: 0 auto; width: 256px; height: auto; border-radius: 5px;"
		...
		<div>
			<h3 style="text-align: center;height : 70px; overflow: hidden;">
